...
class LoRADPORecipeSingleDevice(FTRecipeInterface):
    ...
    def concatenated_forward(
        ...
        # TODO: cross entropy like https://github.com/huggingface/trl/blob/13454d2f4b243b7260fa4ec828297812c3f975fc/trl/trainer/orpo_trainer.py#L699
    ...
    def train(self) -> None:
        ...
        for curr_epoch in range(self.epochs_run, self.total_epochs):
            ...
            for idx, batch in enumerate(self._dataloader):
                ...
                # TODO: add policy_nll_loss like https://github.com/huggingface/trl/blob/13454d2f4b243b7260fa4ec828297812c3f975fc/trl/trainer/orpo_trainer.py#L759
